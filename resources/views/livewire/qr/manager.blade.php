                ...
                >
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            >
                            @error('name')
                                <span class="mt-1.5 block text-xs font-medium text-rose-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        {{-- Campos dinámicos (Sin cambios de lógica) --}}
                        <div class="rounded-xl border border-slate-100 bg-slate-50/30 p-4 dark:text-black">
                            @if ($type === 'text')
                                <div>
                                    ...
                                    ></textarea>
                                    @error('text') <span class="mt-1 block text-xs text-rose-500">{{ $message }}</span> @enderror
                                </div>
                            @endif
                            ...
                            @if ($type === 'url')
                                <div>
                                    ...
                                    @error('url') <span class="mt-1 block text-xs text-rose-500">{{ $message }}</span> @enderror
                                </div>
                            @endif
                            ...
                            @if ($type === 'phone')
                                <div>
                                    ...
                                    @error('phone') <span class="mt-1 block text-xs text-rose-500">{{ $message }}</span> @enderror
                                </div>
                            @endif
                            ...
                            @if ($type === 'whatsapp')
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        @error('whatsapp') <span class="mt-1 block text-xs text-rose-500">{{ $message }}</span> @enderror
                                    </div>
                                    <div>
                            ...
                            @if ($type === 'wifi')
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        @error('wifi_ssid') <span class="mt-1 block text-xs text-rose-500">{{ $message }}</span> @enderror
                                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1.5">
                                ...
                                <div class="flex items-center gap-2 rounded-xl border border-slate-200 bg-white p-2">
                                    ...
                                    <span class="text-xs font-mono text-slate-500">{{ $foreground_color }}</span>
                                </div>
                            </div>
                            <div class="space-y-1.5">
                                ...
                                <div class="flex items-center gap-2 rounded-xl border border-slate-200 bg-white p-2">
                                    ...
                                    <span class="text-xs font-mono text-slate-500">{{ $background_color }}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @forelse ($qrs as $qr)
                                <tr wire:key="qr-{{ $qr->id }}" class="group hover:bg-slate-50/50 transition">
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-bold text-slate-900">{{ $qr->name }}</span>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-2">
                                            <a href="{{ Storage::url($qr->qr_path) }}" target="_blank" class="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm hover:bg-slate-50 hover:text-blue-600 transition" title="Ver original">
                                            ...
                                            <button wire:click="download({{ $qr->id }})" class="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm hover:bg-slate-50 hover:text-emerald-600 transition disabled:opacity-30" title="Descargar">
