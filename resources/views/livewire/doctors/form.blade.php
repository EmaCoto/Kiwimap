  ...
  <div class="max-w-3xl bg-white dark:bg-[#123338]/10 rounded-[2rem] shadow-2xl shadow-black/[0.02] border border-gray-100 dark:border-white/5 p-8 md:p-12">
    <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="md:col-span-2 space-y-2">
        ...
        @error('user_id') <p class="text-[9px] font-black text-rose-600 uppercase tracking-tighter mt-1 ml-1">{{ $message }}</p> @enderror
      </div>
      ...
      <div class="md:col-span-2 space-y-2">
        ...
        @error('specialty') <p class="text-[9px] font-black text-rose-600 uppercase tracking-tighter mt-1 ml-1">{{ $message }}</p> @enderror
      </div>
      ...
      <div class="md:col-span-2 flex items-center gap-4 mt-4 justify-end">
        ...
        <button type="submit" 
          ...
          <div class="flex items-center gap-3">
            ...
            <span>{{ $isEdit ? 'Confirmar Cambios' : 'Finalizar Registro' }}</span>
          </div>
        </button>
      </div>
    </form>
