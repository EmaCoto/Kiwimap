...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Diferencia Horaria')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Diferencia Horaria'))]); ?>
                            ...
                            <tbody class="divide-y divide-gray-200 text-gray-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($w = 4; $w <= 52; $w += 4): ?>
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-3 py-2 text-center border-r"><?php echo e(intval($w / 4)); ?> mes<?php echo e((intval($w / 4) === 1) ? '' : 'es'); ?></td>
                                        <td class="px-3 py-2 text-center font-medium"><?php echo e($w); ?> semanas</td>
                                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views/time_difference.blade.php ENDPATH**/ ?>