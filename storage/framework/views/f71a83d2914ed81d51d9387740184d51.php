        ...
        <div class="w-full">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index === 2): ?> 
            ...
            <div class="mt-3 flex justify-between">
              <div class="flex flex-col"><span class="text-[11px] font-black text-[#02a676]"><?php echo e($byStatus['active']); ?></span><span class="text-[7px] font-bold text-gray-400 uppercase">Activas</span></div>
              <div class="flex flex-col border-x border-gray-100 dark:border-white/5 px-4"><span class="text-[11px] font-black text-[#f56e2a]"><?php echo e($byStatus['renovation']); ?></span><span class="text-[7px] font-bold text-gray-400 uppercase">Reno.</span></div>
              <div class="flex flex-col"><span class="text-[11px] font-black text-[#c93d00]"><?php echo e($byStatus['expired']); ?></span><span class="text-[7px] font-bold text-gray-400 uppercase">Venc.</span></div>
            </div>
          <?php else: ?>
            <div class="flex items-center gap-2">
  ...
  <div class="bg-white dark:bg-[#123338]/10 rounded-lg shadow-2xl shadow-black/[0.02] border border-gray-100 dark:border-white/5 overflow-hidden">
    <div class="p-8 flex items-center justify-between border-b border-gray-50 dark:border-white/5 bg-gray-50/20 dark:bg-white/2">
      ...
      <div class="flex items-center gap-2 px-4 py-2 rounded-xl bg-white dark:bg-[#123338] border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          <span class="text-[10px] font-black text-[#f56e2a] uppercase italic"><?php echo e($soonDays); ?> Días</span>
      </div>
    </div>
        ...
        <tbody class="divide-y divide-gray-50 dark:divide-white/5">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $expiringSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="group hover:bg-[#123338]/[0.02] dark:hover:bg-white/[0.02] transition-all duration-300">
              <td class="px-8 py-6">
                <div class="text-sm font-black text-[#123338] dark:text-gray-200 uppercase tracking-tighter italic group-hover:text-[#02a676] transition-colors leading-none"><?php echo e($l->doctor?->user?->name ?? 'No asignado'); ?></div>
...
</div><?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views/livewire/dashboard/metrics.blade.php ENDPATH**/ ?>