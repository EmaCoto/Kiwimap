...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Cheat Sheet Front Desk']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cheat Sheet Front Desk']); ?>
    <article class="flex w-full min-w-0 flex-col gap-5 rounded-3xl bg-[#fcfcfc] p-4 font-sans text-[#123338] sm:p-6 lg:p-10 dark:bg-[#0d1516] dark:text-gray-200">
        <h1 id="front-desk-section-1" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Consultation ($100)</strong></h1>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-1" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-1">
                <colgroup>
                    <col style="width: 48.8619%" />
                    <col style="width: 51.1381%" />
                </colgroup>
                <thead class="bg-[#351d5b]/5 text-[#351d5b] dark:bg-white/5 dark:text-white">
                    <tr>
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>ENGLISH</strong></p>
                        </th>
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>SPANISH</strong></p>
                        </th>
                    </tr>
                </thead>
                <tbody>
        ...
        <h2 id="front-desk-section-2" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Medical Weight Loss Program Consultation ($149)</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-2" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-2">
                <colgroup>
                    <col style="width: 48.8619%" />
                    <col style="width: 51.1381%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-2" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-2">
                ...
                <thead class="bg-[#351d5b]/5 text-[#351d5b] dark:bg-white/5 dark:text-white">
                    <tr>
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Procedure</strong></p>
                        </th>
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Follow-Up</strong></p>
                        </th>
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Sessions/ Treatment</strong></p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Medical Weight Loss</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-6 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"></p>
                        </td>
        ...
        <h2 id="front-desk-section-3" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Opus</strong></h2>
        <h2 id="front-desk-section-4" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Skin Resurfacing / Renovación de la Piel</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-4" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-4">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
            ...
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-4">
                ...
                <thead class="bg-[#351d5b]/5 text-[#351d5b] dark:bg-white/5 dark:text-white">
                    <tr>
                        ...
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Sessions</strong></p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Skin Resurfacing </p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2 day, 4 Weeks between sessions</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3 Sessions</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h2 id="front-desk-section-5" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Veil</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-5" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-5">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-5" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-5">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Vascular Lesion</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-6 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">1-3 Sessions, or Until Lesions Clearance</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Skin Revitalization/Micro Pulse</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2-4 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6-8<strong> </strong>Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Pigmented LesionsSkin<strong> </strong></p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-4 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-5 Sessions</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h2 id="front-desk-section-6" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Accent Prime</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-6" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-6">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-6" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-6">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Facial &amp; Body (All Parts) Contouring</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-6 Sessions</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h2 id="front-desk-section-7" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Ted</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-7" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-7">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
            ...
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-7">
                ...
                <thead class="bg-[#351d5b]/5 text-[#351d5b] dark:bg-white/5 dark:text-white">
                    <tr>
                        ...
                        <th scope="col" class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Sessions/ Treatments</strong></p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Hair Restoration</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3 Sessions</p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Scalp Mesoneedling</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Every 7 Days</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">10 Sessions</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h2 id="front-desk-section-8" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Harmony</strong></h2>
        <h2 id="front-desk-section-9" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Q-Switch, Dye-VL, XL Fungus Pro</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-9" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-9">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-9" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-9">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Tattoo Removal</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6-8 Weeks </p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-10 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Harmony Dye-vl &amp; Pigmented Lesion Treatment </p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-4 Weeks </p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Laser Nail Fungus Treatment</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2-4 Weeks </p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Harmony Clearlift</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-4 Weeks </p>
                        </td>
        ...
        <h2 id="front-desk-section-10" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Botox</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-10" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-10">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <h2 id="front-desk-section-11" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>i-Pixel Co2/ Pixel Co2</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-11" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-11">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-11" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-11">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">FemiLift/ Femi Co2 Pixel</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4 Weeks</p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Pixel Peel/ Pixel Co2</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2 days, following every 2 Weeks, Repeat Session 4-6 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">1-2, or 3 Varies</p>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h2 id="front-desk-section-12" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Alma Soprano</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-12" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-12">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-12" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-12">
                <colgroup>
                    <col style="width: 36.859%" />
                    <col style="width: 29.8077%" />
                    <col style="width: 33.3333%" />
                </colgroup>
                <thead class="bg-[#351d5b]/5 text-[#351d5b] dark:bg-white/5 dark:text-white">
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Face/Neck/Lips/Chin</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Underarm</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6 Weeks </p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6 Sessions</p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Bikini/Brazilian</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">6 Weeks</p>
                        </td>
        ...
        <h2 id="front-desk-section-13" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Facials/ Skin Boosters</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-13" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-13">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>AQUA GLOW FACIALS:</strong> (<strong>Kiwi </strong><strong>Diamond</strong>, <strong>Kiwi </strong><strong>Aqua</strong>, <strong>Kiwi </strong><strong>Aqua Luxe Lift</strong>, <strong>The Elite</strong><strong> Kiwi, </strong><strong>The Platinum </strong><strong>Kiwi, </strong><strong>The</strong><strong> Kiwi </strong><strong>Luxe Trilogy</strong>)</p>
                            <p class="min-h-5">(<strong>For Aqua Glow Facials</strong>)</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>FACIALES AQUA GLOW:</strong> (<strong>Kiwi </strong><strong>Diamond</strong>, <strong>Kiwi </strong><strong>Aqua</strong>, <strong>Kiwi </strong><strong>Aqua Luxe Lift</strong>, <strong>The Elite</strong><strong> Kiwi, </strong><strong>The Platinum </strong><strong>Kiwi, </strong><strong>The</strong><strong> Kiwi </strong><strong>Luxe Trilogy</strong>)</p>
                            <p class="min-h-5"><strong>(Faciales Aqua Glow)</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
        ...
        <h2 id="front-desk-section-14" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Facial </strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-14" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-14">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Kiwi Reset</strong></p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Kiwi Glass renewal</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"><strong>Kiwi Frequency</strong></p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"></p>
                        </td>
        ...
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-14" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-14">
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Medical-Grade Chemical Peel</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-4 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Aqua Glow Signature facial</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-6 Weeks </p>
                        </td>
                    ...
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Microneedling</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4-6 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">3-6 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">PRX - PLUS</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">2 Weeks</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">5 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">PRX - PERFECTION</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Every 7 Days</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">4 Sessions</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5">Mesoneedling</p>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 align-top wrap-break-words dark:border-white/10">
                            <p class="min-h-5"></p>
                        </td>
        ...
        <h2 id="front-desk-section-15" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Fillers</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-15" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-15">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <h2 id="front-desk-section-16" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>V-Tech add on</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-16" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-16">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
        ...
        <h2 id="front-desk-section-17" class="mt-4 border-l-4 border-[#02a676] pl-3 text-xl font-bold text-[#351d5b] first:mt-0 dark:text-white"><strong>Toskani Add On</strong></h2>
        <div class="overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#123338]/10" role="region" aria-labelledby="front-desk-section-17" tabindex="0">
            <table class="w-full min-w-140px table-fixed border-collapse text-left text-sm leading-relaxed" aria-labelledby="front-desk-section-17">
                <colgroup>
                    <col style="width: 50%" />
                    <col style="width: 50%" />
                </colgroup>
...
<?php endif; ?>
<?php /**PATH C:\Users\EOCHOA\Desktop\Kiwimap\resources\views/cheat_sheet_front_desk.blade.php ENDPATH**/ ?>