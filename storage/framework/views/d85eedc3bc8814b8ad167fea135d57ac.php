<div class="p-6 space-y-6">
  <div class="flex items-center justify-between gap-3">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Doctor::class)): ?>
      <a href="<?php echo e(route('doctors.create')); ?>" class="flex items-center px-3 py-2 text-neutral-50 rounded-lg group hover:shadow shadow-[#31353d] dark:shadow-[#4a4e58] bg-gradient-to-t active:bg-gradient-to-b from-[#6fa31c] to-[#123338] transition ease-in-out duration-300 text-sm hover:scale-105  font-semibold">
...
<?php endif; ?><?php echo e(session('ok')); ?></div>
  ...
  <div class="flex items-center justify-between">
    ...
    <span class="text-xs text-gray-500">Resultados: <?php echo e($doctors->total()); ?></span>
  </div>
      ...
      <tbody class="divide-y">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr class="hover:bg-gray-100 dark:hover:text-black">
            <td class="p-2 whitespace-nowrap"><?php echo e($d->user?->name ?? '—'); ?></td>
            <td class="p-2 whitespace-nowrap"><?php echo e($d->user?->email ?? '—'); ?></td>
            <td class="p-2"><?php echo e($d->specialty ?? '—'); ?></td>
            <td class="p-2 space-x-2 flex">
              <a href="<?php echo e(route('doctors.edit', $d)); ?>" class="text-blue-600 hover:underline text-xs"><?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
...
<?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views/livewire/doctors/index.blade.php ENDPATH**/ ?>