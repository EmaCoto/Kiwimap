<div class="max-w-6xl mx-auto p-6 space-y-10">
  ...
  <div class="flex flex-wrap items-end gap-3 px-2">
    <div class="space-y-1">
        <h1 class="text-3xl font-black text-[#123338] dark:text-white tracking-tighter uppercase italic"><?php echo e(__('Upcoming Milestones')); ?></h1>
    ...
    <div class="ms-auto flex items-center gap-4">
      ...
      <div class="flex flex-col">
        <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1 ml-1"><?php echo e(__('Month')); ?></label>
        <select wire:model.live="month" class="border border-gray-200 dark:border-white/10 bg-white dark:bg-[#123338] rounded-lg p-2 text-[11px] font-bold uppercase tracking-tight focus:ring-1 focus:ring-[#6fa31c] outline-none">
          <option value="" class="dark:text-black"><?php echo e(__('Current month')); ?></option>
      ...
      <div class="flex flex-col">
        <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1 ml-1"><?php echo e(__('Type')); ?></label>
        <select wire:model.live="type" class="border border-gray-200 dark:border-white/10 bg-white dark:bg-[#123338] rounded-lg p-2 text-[11px] font-bold uppercase tracking-tight focus:ring-1 focus:ring-[#6fa31c] outline-none">
          <option value="all" class="dark:text-black"><?php echo e(__('All')); ?></option>
          <option value="birthday" class="dark:text-black"><?php echo e(__('Birthday')); ?></option>
          <option value="kiwimed" class="dark:text-black"><?php echo e(__('Dr. Kiwimed Anniversary')); ?></option>
          <option value="group" class="dark:text-black"><?php echo e(__('Group Anniversary')); ?></option>
        </select>
      </div>

      
      <div class="self-end">
        <button wire:click="clearFilters" type="button" class="px-5 py-2.5 rounded-lg bg-gradient-to-t from-[#123338] to-[#1a444a] text-white text-[10px] font-black uppercase tracking-[0.2em] shadow-lg hover:scale-105 transition-all active:scale-95"><?php echo e(__('Clear filters')); ?></button>
      </div>
      ...
      <div class="self-end">
        <button wire:click="exportExcel" wire:loading.attr="disabled" wire:target="exportExcel" type="button" class="px-5 py-2.5 rounded-lg bg-gradient-to-t from-[#6fa31c] to-[#85b82e] text-white text-[10px] font-black uppercase tracking-[0.2em] shadow-lg hover:scale-105 transition-all active:scale-95 disabled:cursor-wait disabled:opacity-60">
          <span wire:loading.remove wire:target="exportExcel"><?php echo e(__('Download Excel')); ?></span>
          <span wire:loading wire:target="exportExcel"><?php echo e(__('Preparing...')); ?></span>
        </button>
      </div>
    </div>
  ...
  <div class="space-y-4">
    <h2 class="text-[11px] font-black text-[#02a676] uppercase tracking-[0.4em] px-2 italic"><?php echo e(__('Milestones in :month', ['month' => $monthNames[$currentMonthNum]])); ?></h2>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($upcomingCurrentMonth)): ?>
      <div class="mx-2 p-8 rounded-2xl border-2 border-dashed border-gray-100 dark:border-white/5 text-gray-400 text-[10px] font-black uppercase tracking-widest text-center">
        <?php echo e(__('No upcoming milestones for the rest of the month.')); ?>
          ...
          <div class="group relative bg-white dark:bg-[#123338]/20 border border-gray-100 dark:border-white/5 rounded-2xl p-4 transition-all hover:shadow-2xl hover:shadow-[#123338]/10 hover:-translate-y-1 overflow-hidden">
            ...
            <div class="flex items-center gap-4">
              <div class="flex-shrink-0">
                <img src="<?php echo e($avatar); ?>" class="h-14 w-14 rounded-full object-cover shadow-sm" alt="<?php echo e(__('Avatar')); ?>">
              </div>
              <div class="flex-1">
  ...
  <div class="space-y-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($monthItems)): ?>
      <div class="mx-2 p-8 rounded-2xl border border-dashed border-gray-200 dark:border-white/10 text-gray-400 text-[10px] font-black uppercase tracking-widest text-center">
        <?php echo e(__('No results for the selected filters for this month.')); ?>
          ...
          <div class="rounded-2xl border <?php echo e($border); ?> p-4 transition-all hover:bg-gray-50 dark:hover:bg-white/[0.07]">
            ...
            <div class="mt-3 flex justify-between items-center flex-wrap gap-2">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($past): ?>
                <span class="text-[8px] font-black text-red-500/50 uppercase italic tracking-tighter shrink-0"><?php echo e(__('Event Past')); ?></span>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
</div><?php /**PATH C:\Users\EOCHOA\Desktop\Kiwimap\resources\views\livewire\users\upcoming-celebrations.blade.php ENDPATH**/ ?>