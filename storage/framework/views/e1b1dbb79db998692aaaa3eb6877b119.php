        ...
        <div class="flex flex-col md:flex-row justify-between items-end gap-6 px-2">
            <div class="space-y-1">
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-3xl font-black text-[#123338] dark:text-white tracking-widest uppercase "><?php echo e(__('Tentative Service Price List')); ?></h1>
                </div>
                <p class="text-[10px] font-black text-[#02a676] uppercase tracking-[0.5em] ml-3">
                    <?php echo e(__('Updated on: 01/16/2026')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'currency-dollar','class' => 'h-4 w-4 text-[#02a676]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'currency-dollar','class' => 'h-4 w-4 text-[#02a676]']); ?>
...
<?php endif; ?>
                <span class="text-[9px] font-black text-gray-700 dark:text-white uppercase tracking-widest"><?php echo e(__('Official Rates')); ?></span>
            </div>
        </div>
        ...
        <div class="space-y-3 flex flex-col">
            ...
            <div class="bg-[#02a676]/5 border-l-4 border-[#02a676] p-4 rounded-r-2xl max-w-2xl">
                <div class="flex items-start gap-3">
                    <?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'information-circle','class' => 'h-5 w-5 text-[#02a676] mt-0.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'information-circle','class' => 'h-5 w-5 text-[#02a676] mt-0.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2)): ?>
<?php $attributes = $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2; ?>
...
<?php endif; ?>
                    <div class="space-y-2">
                        <p class="text-sm font-bold text-[#123338] dark:text-white leading-tight">
                            <?php echo e(__('Patients of Georgia, ask if they live within a 25 air-mile straight-line radius from ZIP code 30566.')); ?>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            >
                                <?php echo e(__('Click here to check the radius')); ?>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="text-[9px] font-black text-gray-700 dark:text-gray-200 uppercase tracking-[0.2em] border-b border-gray-50 dark:border-white/5 bg-gray-50/30">
                            <th class="px-6 py-5"><?php echo e(__('Membership')); ?></th>
                            <th class="px-6 py-5 w-48"><?php echo e(__('Price')); ?></th>
                            <th class="px-6 py-5"><?php echo e(__('Benefits')); ?></th>
                            <th class="px-6 py-5"><?php echo e(__('Notes')); ?></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                        ...
                        <tr class="group hover:bg-[#123338]/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-6 py-6 text-[10px] font-bold text-gray-500 dark:text-gray-200 uppercase leading-relaxed tracking-widest">
                                <?php echo __('- All the benefits of Bronze, plus: <br> - Includes weight loss consultations and follow ups'); ?>

                            </td>
                            <td class="px-6 py-6 text-[9px] font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">
                                <?php echo e(__('Only one weightloss consultation a month.')); ?>
                        ...
                        <tr class="group hover:bg-[#123338]/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-6 py-6 text-[10px] font-bold text-gray-500 dark:text-gray-200 uppercase leading-relaxed tracking-widest">
                                <?php echo e(__('- Comprehensive access to all our health services, including weight loss.')); ?>

                            </td>
                            <td class="px-6 py-6 text-[9px] font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">
                                <?php echo e(__('Maximum of two visits a month.')); ?>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="text-[9px] font-black text-white uppercase tracking-[0.2em] bg-[#123338]">
                            <th class="px-6 py-4"><?php echo e(__('Service')); ?></th>
                            <th class="px-6 py-4 w-36"><?php echo e(__('Price')); ?></th>
                            <th class="px-6 py-4"><?php echo e(__('Notes')); ?></th>
                            <th class="px-6 py-4"><?php echo e(__('FORMS / INTAKES')); ?></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                        <?php
        ...
        <div class="px-2 py-4 border-t border-gray-100 dark:border-white/5">
            <p class="text-[8px] font-black text-gray-700 uppercase tracking-[0.5em] text-center dark:text-gray-200"><?php echo e(__('Executive Pricing Report - Internal Use Only')); ?></p>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\EOCHOA\Desktop\Kiwimap\resources\views\pricing.blade.php ENDPATH**/ ?>