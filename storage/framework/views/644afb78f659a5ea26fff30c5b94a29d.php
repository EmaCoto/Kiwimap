<div class="flex h-full w-full flex-1 flex-col gap-8 p-6 bg-[#fcfcfc] dark:bg-[#0d1516] rounded-3xl">
  <div class="flex flex-col md:flex-row justify-between items-end gap-6 px-2">
    <div class="space-y-1">
      <div class="flex items-center gap-2">
        ...
        <h1 class="text-3xl font-black text-[#123338] dark:text-white tracking-tighter uppercase italic">
          <?php echo e($isEdit ? 'Editar información' : 'Nueva información'); ?>
    ...
    <a href="<?php echo e($redirect ?? route('information.index')); ?>"
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="md:col-span-2 space-y-2">
        <div class="flex items-center justify-between gap-3">
          ...
          <span class="text-[9px] font-black text-gray-300 uppercase tracking-widest"><?php echo e(mb_strlen($name)); ?>/150</span>
        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="md:col-span-2 space-y-2">
        <div class="flex items-center justify-between gap-3">
          ...
          <span class="text-[9px] font-black text-gray-300 uppercase tracking-widest"><?php echo e(mb_strlen($information)); ?>/100</span>
        </div>
...
<?php unset($__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2); ?>
<?php endif; ?>
            <span wire:loading.remove wire:target="save"><?php echo e($isEdit ? 'Actualizar información' : 'Guardar información'); ?></span>
...
</div><?php /**PATH C:\Users\EOCHOA\Desktop\Kiwimap\resources\views\livewire\information\form.blade.php ENDPATH**/ ?>