        ...
        <tbody class="divide-y divide-gray-50 dark:divide-white/5">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors group">
              ...
              <td class="p-4">
                <button type="button" wire:click="$dispatch('open-attendance', { userId: <?php echo e($u->id); ?> })" class="text-left group/btn">
                  <div class="text-[11px] font-black text-[#123338] dark:text-white uppercase italic tracking-tight group-hover/btn:text-[#6fa31c] transition-colors"><?php echo e($u->name); ?></div>
...
[$__name, $__params] = $__split('users.attendance-modal', []);

$key = 'users-attendance-modal';

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2820713866-0', 'users-attendance-modal');
...
$key = 'users-user-details-modal';

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2820713866-1', 'users-user-details-modal');
...
<?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views/livewire/users/index.blade.php ENDPATH**/ ?>