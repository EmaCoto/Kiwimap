<div class="flex h-full w-full flex-1 flex-col gap-8 p-6 bg-[#fcfcfc] dark:bg-[#0d1516] rounded-3xl">
  <div class="flex flex-col md:flex-row justify-between items-end gap-6 px-2">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Information\Index::class)): ?>
      <a href="<?php echo e(route('information.create')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['name' => 'plus','class' => 'h-4 w-4 text-[#6fa31c]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'plus','class' => 'h-4 w-4 text-[#6fa31c]']); ?>
              ...
              <td class="px-8 py-6 text-right">
                <div class="flex justify-end gap-2">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $record)): ?>
                    <a href="<?php echo e(route('information.edit', $record)); ?>"
                       aria-label="Editar <?php echo e($record->name); ?>"
...
<?php endif; ?>
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $record)): ?>
                    <button x-data @click.prevent="if (confirm('¿Eliminar este registro de información?')) { $wire.delete(<?php echo e($record->id); ?>) }"
                            type="button"
                            aria-label="Eliminar <?php echo e($record->name); ?>"
...
</div><?php /**PATH C:\Users\EOCHOA\Desktop\Kiwimap\resources\views\livewire\information\index.blade.php ENDPATH**/ ?>