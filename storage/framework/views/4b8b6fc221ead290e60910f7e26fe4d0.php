...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('measurement_converter'))]); ?>
    ...
    <div class="flex flex-col md:flex-row justify-between items-end gap-6 px-2">
        <div class="space-y-1">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-3xl font-black text-[#123338] dark:text-white tracking-tighter uppercase italic">Precision Converter</h1>
            </div>
            <p class="text-[10px] font-black text-[#02a676] uppercase tracking-[0.5em] ml-3">System Metrics / Unit Analysis</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="relative group p-8 rounded-lg bg-white dark:bg-[#123338]/30 border border-gray-100 dark:border-white/5 shadow-[0_15px_35px_-15px_rgba(0,0,0,0.05)] transition-all duration-300">
            <div class="relative z-10 flex flex-col items-start h-full">
                <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4">Length (Metric to Imperial)</p>

                <div class="w-full space-y-4">
                    <div>
                        <label class="text-[9px] font-black uppercase tracking-widest text-[#02a676] mb-1 block">Meters (m)</label>
                    ...
                    <div class="flex flex-col gap-4 mt-6">
                        ...
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Feet (ft)</p>
                        <div id="resPies" class="text-5xl font-black italic tracking-tighter text-[#123338] dark:text-white">0.00</div>
                        </div>
                        <div class="flex justify-between items-end">
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Inches (in)</p>
                ...
                <div class="mt-8 flex items-center gap-2">
                    ...
                    <p class="text-[9px] font-black text-gray-500 dark:text-gray-100 uppercase tracking-[0.2em]">High Fidelity Conversion</p>
                </div>
            </div>
        </div>
        ...
        <div class="relative group p-8 rounded-lg bg-white dark:bg-[#123338]/30 border border-gray-100 dark:border-white/5 shadow-[0_15px_35px_-15px_rgba(0,0,0,0.05)] transition-all duration-300">
            <div class="relative z-10 flex flex-col items-start h-full">
                <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4">Mass (Kilograms to Pounds)</p>

                <div class="w-full space-y-4">
                    <div>
                        <label class="text-[9px] font-black uppercase tracking-widest text-[#f56e2a] mb-1 block">Kilograms (kg)</label>
                    ...
                    <div class="mt-6">
                        <p class="text-[10px] font-black text-gray-400 uppercase mb-1 tracking-widest">Pounds (lb)</p>
                ...
                <div class="mt-8 flex items-center gap-2">
                    ...
                    <p class="text-[9px] font-black text-gray-500 dark:text-gray-100 uppercase tracking-[0.2em]">Constant: 2.20462 lb/kg</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-[#123338]/10 rounded-lg border border-gray-100 dark:border-white/5 p-4 flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <h2 class="text-[10px] font-black uppercase tracking-widest italic text-gray-400 dark:text-white">Active Processing Engine</h2>
        </div>
    </div>
    </div>
...
<?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views/measurement_converter.blade.php ENDPATH**/ ?>