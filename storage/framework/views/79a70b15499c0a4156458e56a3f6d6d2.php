...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('Profile'),'subheading' => __('Update your name, email and avatar')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-6" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="shrink-0">
                    ...
                    ?>
                    <img
                        src="<?php echo e($src ?: $placeholder); ?>"
                        alt="Avatar"
...
<?php endif; ?>
</section><?php /**PATH C:\Users\EOchoa\Escritorio\Kiwimap\resources\views\livewire/settings/profile.blade.php ENDPATH**/ ?>